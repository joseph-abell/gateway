		  ...
		  return (
		    <React.Fragment>
		      ...
		      <main>
		        ...
		        />
		        <ul>
		          <li><Link to="people?filter=all">All</Link></li>
		          <li><Link to="people?filter=elders">Elders</Link></li>
		          <li><Link to="people?filter=lifegroup-leaders">Lifegroup Leaders</Link></li>
		          <li><Link to="people?filter=ministry-leaders">Ministry Leaders</Link></li>
		          <li><Link to="people?filter=staff">Staff</Link></li>
		          <li><Link to="people?filter=trustees">Trustees</Link></li>
		        </ul>
		      </main>
		      <Footer />
		    </React.Fragment>
