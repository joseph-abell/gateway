    ...
    RNiq: function(e, t, n) {
        ...
        E = function(e) {
          ...
          return b(
            ...
            b(
              y.Link,
              {href: t},
              b(x, {colour: i}, b(h.a, {url: o}), b(k, null, n), b(_, null, r))
            )
          );
        },
        M = function(e) {
          var t = e.cta;
          return b(j, null, t.map(E));
        },
        P = n('OS56'),
        C = n.n(P),
        L = i.createElement;
      ...
      var I = {
        ...
        q = function(e) {
          var t = e.quote,
            n = e.author;
          return L('div', {key: t}, L(H, null, t), L(N, null, n));
        },
        A = function(e) {
          var t = e.quotes;
          return L(W, I, t.map(q));
        },
        Y = n('lHlY'),
        F = i.createElement;
      function B() {
      ...
      var V = s.a.div(X(), function(e) {
          return e.colour;
        }),
        U = s.a.div(B(), function(e) {
          return e.src;
        }),
        G = function(e) {
          var t = e.colour,
          ...
          return F(
            f.a,
            null,
            F(V, {colour: t, dangerouslySetInnerHTML: {__html: n}}),
            F(v.a, {mobileHeight: '400px'}, F(U, {src: r})),
            F(Y.a, null)
          );
        },
        K = n('wd/R'),
      ...
      var ae = s.a.h3(ie(), function(e) {
          return e.colour;
        }),
        se = s.a.ul(oe(), function(e) {
          return e.colour;
        }),
        le = s.a.li(re()),
        ue = s.a.p(ne(), function(e) {
          return e.colour;
        }),
        ce = s.a.a(te()),
        de = s.a.div(ee(), function(e) {
          return e.colour;
        }),
        fe = s.a.div($(), function(e) {
          return e.colour;
        }),
        pe = function(e) {
          var t = e.colour,
          ...
          return (
            Object(i.useEffect)(function() {
              Object(J.c)('data/events/index.json').then(function(e) {
                ...
                u(
                  t
                    ...
                    .sort(function(e, t) {
                      return Z()(e.dateTime).isAfter(t.dateTime) ? 1 : -1;
                    })
                    .filter(function(e) {
                      return Z()().isBefore(e.dateTime);
                    })
                    .slice(0, 3)
                ),
                  a(!1);
            ...
            o
              ...
              : Q(
                        ...
                        Q(
                          ...
                          Q(
                            ...
                            Q(
                              ue,
                              {colour: t},
                              Z()(e.dateTime).format('dddd MMM Do YYYY')
                            ),
                            Q(
                              'p',
                              null,
                            ...
                            Q('p', null, Z()(e.dateTime).format('kk:mm'))
                          )
                        )
                      );
                    })
                  ...
                  Q(
                    de,
                    {colour: n},
                    Q(y.Link, {href: '/events'}, Q(ce, null, 'More Events'))
                  )
                )
          );
        },
      ...
      t.default = function() {
        ...
        if (
          (Object(i.useEffect)(function() {
            Object(J.c)('data/homepage.json').then(function(e) {
              y(e.header.title),
                m(e.header.image),
                O(Object(J.d)(e.deck.image)),
                x(Object(J.a)(e.deck.colour)),
                E(e.deck.text);
              var t = Object(J.b)(Object(J.g)(e)),
                n = Object(r.a)(t, 3),
                i = n[0],
                a = n[1],
                s = n[2];
              L(i),
                R(a),
                N(s),
                V(Object(J.d)(e.eventsImage)),
                Z(Object(J.d)(e.twitterImage)),
                ee(e.quotes),
                F(
                  e.cta.map(function(e) {
                    return (
                      (e.image = Object(J.d)(e.image)),
                      (e.colour = Object(J.a)(e.colour)),
                      e
                    );
                  })
                ),
        ...
        return he(
          a.a.Fragment,
          null,
          he(u.a, null, he('title', {key: 'title'}, 'Gateway Church, York')),
          he(d.a, {
            colour: C,
            colourHex: D,
            colourHexLight: H,
          ...
          he(
            ...
            he(
              ...
              he(
                ...
                he(v.a, {mobileHeight: '400px'}, he(h.a, {url: K}))
              )
            )
          ),
          he(c.a, null)
