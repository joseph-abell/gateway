...
// EXTERNAL MODULE: ./router.js
var router_0 = __webpack_require__(3);

// EXTERNAL MODULE: ./templates/Header.js + 3 modules
...
var HeaderContainer = __webpack_require__(19);

// EXTERNAL MODULE: ./components/PageSummary.js
var PageSummary = __webpack_require__(27);

// EXTERNAL MODULE: ./components/Image.js
var Image = __webpack_require__(14);
...
// CONCATENATED MODULE: ./components/LinkWords.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  background-color: ", ";\n  display: block;\n  color: white;\n"]);
...
var Link = external_styled_components_default.a.a(_templateObject(), function (props) {
  return props.colour;
});
/* harmony default export */ var LinkWords = (Link);
// CONCATENATED MODULE: ./components/TextWords.js
function TextWords_templateObject() {
  var data = TextWords_taggedTemplateLiteral(["\n  padding: 40px;\n"]);

  TextWords_templateObject = function _templateObject() {
    return data;
  };
...
function TextWords_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var Text = external_styled_components_default.a.div(TextWords_templateObject());
/* harmony default export */ var TextWords = (Text);
// CONCATENATED MODULE: ./components/DateWords.js
function DateWords_templateObject() {
  var data = DateWords_taggedTemplateLiteral(["\n  color: ", ";\n  margin-bottom: 40px;\n"]);

  DateWords_templateObject = function _templateObject() {
    return data;
  };
...
function DateWords_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var StyledDate = external_styled_components_default.a.div(DateWords_templateObject(), function (props) {
  return props.colour;
});
/* harmony default export */ var DateWords = (StyledDate);
// CONCATENATED MODULE: ./components/H2Words.js
function H2Words_templateObject() {
  var data = H2Words_taggedTemplateLiteral(["\n  font-size: 30px;\n  line-height: 42px;\n  max-height: 84px;\n  margin-bottom: 1em;\n"]);

  H2Words_templateObject = function _templateObject() {
    return data;
  };
...
function H2Words_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var H2 = external_styled_components_default.a.h2(H2Words_templateObject());
/* harmony default export */ var H2Words = (H2);
// CONCATENATED MODULE: ./components/ReadMoreWords.js
function ReadMoreWords_templateObject() {
  var data = ReadMoreWords_taggedTemplateLiteral(["\n  padding: 40px;\n  background-color: ", ";\n  color: white;\n\n  @media screen and (min-width: 991px) {\n    position: absolute;\n    bottom: 0;\n    width: 50%;\n  }\n"]);

  ReadMoreWords_templateObject = function _templateObject() {
    return data;
  };
...
function ReadMoreWords_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var ReadMore = external_styled_components_default.a.div(ReadMoreWords_templateObject(), function (props) {
  return props.colour;
});
/* harmony default export */ var ReadMoreWords = (ReadMore);
// CONCATENATED MODULE: ./components/TextContainerWords.js
function TextContainerWords_templateObject() {
  var data = TextContainerWords_taggedTemplateLiteral(["\n  @media screen and (min-width: 991px) {\n    float: left;\n    width: 50%;\n  }\n"]);

  TextContainerWords_templateObject = function _templateObject() {
    return data;
  };
...
function TextContainerWords_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var StyledTextContainer = external_styled_components_default.a.div(TextContainerWords_templateObject());
/* harmony default export */ var TextContainerWords = (StyledTextContainer);
// CONCATENATED MODULE: ./components/HideOnMobile.js
function HideOnMobile_templateObject() {
  var data = HideOnMobile_taggedTemplateLiteral(["\n  display: none;\n\n  @media screen and (min-width: 768px) {\n    display: block;\n  }\n"]);

  HideOnMobile_templateObject = function _templateObject() {
    return data;
  };
...
function HideOnMobile_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var HideOnMobile = external_styled_components_default.a.div(HideOnMobile_templateObject());
/* harmony default export */ var components_HideOnMobile = (HideOnMobile);
// CONCATENATED MODULE: ./components/HideOnMobileWords.js
function HideOnMobileWords_templateObject() {
  var data = HideOnMobileWords_taggedTemplateLiteral(["\n  float: right;\n  width: 50%;\n"]);

  HideOnMobileWords_templateObject = function _templateObject() {
    return data;
  };
...
function HideOnMobileWords_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }



var StyledHideOnMobile = external_styled_components_default()(components_HideOnMobile)(HideOnMobileWords_templateObject());
/* harmony default export */ var HideOnMobileWords = (StyledHideOnMobile);
// CONCATENATED MODULE: ./components/WordWords.js
function WordWords_templateObject() {
  var data = WordWords_taggedTemplateLiteral(["\n  @media screen and (min-width: 991px) {\n    position: relative;\n    height: 500px;\n    margin-bottom: 20px;\n  }\n"]);

  WordWords_templateObject = function _templateObject() {
    return data;
  };
...
function WordWords_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var Word = external_styled_components_default.a.li(WordWords_templateObject());
/* harmony default export */ var WordWords = (Word);
// CONCATENATED MODULE: ./components/NotLinkWords.js
function NotLinkWords_templateObject() {
  var data = NotLinkWords_taggedTemplateLiteral(["\n  display: inline-block;\n  margin-right: 20px;\n"]);

  NotLinkWords_templateObject = function _templateObject() {
    return data;
  };
...
function NotLinkWords_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var StyledNotLink = external_styled_components_default.a.div(NotLinkWords_templateObject());
/* harmony default export */ var NotLinkWords = (StyledNotLink);
// CONCATENATED MODULE: ./components/PaginationLinkWords.js
function PaginationLinkWords_templateObject() {
  var data = PaginationLinkWords_taggedTemplateLiteral(["\n  display: inline-block;\n  margin-right: 20px;\n  color: #fff;\n  border-bottom: 2px solid #fff;\n"]);

  PaginationLinkWords_templateObject = function _templateObject() {
    return data;
  };
...
function PaginationLinkWords_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var PaginationLink = external_styled_components_default.a.a(PaginationLinkWords_templateObject());
/* harmony default export */ var PaginationLinkWords = (PaginationLink);
...
var Pagination_Pagination = function Pagination(_ref) {
  ...
  return links.map(function (link) {
    if (link === parseInt(currentPage)) {
      return external_react_default.a.createElement(NotLinkWords, {
        key: link
      }, link);
    }

    if (link === 1) {
      return external_react_default.a.createElement(router_0["Link"], {
        href: "words",
        key: link,
        passHref: true
      }, external_react_default.a.createElement(PaginationLinkWords, null, link));
    }
...
// CONCATENATED MODULE: ./components/PaginationWords.js
function PaginationWords_templateObject() {
  var data = PaginationWords_taggedTemplateLiteral(["\n  background: ", ";\n  padding: 10px 20px;\n  margin-top: 10px;\n  margin-bottom: 10px;\n  color: #fff;\n"]);

  PaginationWords_templateObject = function _templateObject() {
    return data;
  };
...
function PaginationWords_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var PaginationWords_Pagination = external_styled_components_default.a.div(PaginationWords_templateObject(), function (props) {
  return props.color;
});
/* harmony default export */ var PaginationWords = (PaginationWords_Pagination);
// CONCATENATED MODULE: ./components/Subtitle.js
function Subtitle_templateObject() {
  var data = Subtitle_taggedTemplateLiteral(["\n  font-size: 1.3em;\n  line-height: 1.3em;\n"]);
...
function Subtitle_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var Subtitle = external_styled_components_default.a.h3(Subtitle_templateObject());
/* harmony default export */ var components_Subtitle = (Subtitle);
// EXTERNAL MODULE: ./components/ImageWrapper.js
var ImageWrapper = __webpack_require__(20);

// CONCATENATED MODULE: ./components/ImageWrapperWords.js
function ImageWrapperWords_templateObject() {
  var data = ImageWrapperWords_taggedTemplateLiteral(["\n  min-height: 274px;\n  margin-bottom: 0;\n"]);

  ImageWrapperWords_templateObject = function _templateObject() {
    return data;
  };
...
function ImageWrapperWords_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }



var StyledImageWrapper = external_styled_components_default()(ImageWrapper["a" /* default */])(ImageWrapperWords_templateObject());
/* harmony default export */ var ImageWrapperWords = (StyledImageWrapper);
// EXTERNAL MODULE: ./helpers/index.js
var helpers = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/words.js
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }
...
var words_Words = function Words(_ref) {
  ...
  var _useState7 = Object(external_react_["useState"])(''),
      _useState8 = _slicedToArray(_useState7, 2),
      colourHexLight = _useState8[0],
      setColourHexLight = _useState8[1];
  ...
  var _useState13 = Object(external_react_["useState"])(''),
      ...
      subtitle = _useState14[0],
      setSubtitle = _useState14[1];
  ...
  var _useState17 = Object(external_react_["useState"])(0),
      _useState18 = _slicedToArray(_useState17, 2),
      maxPageCount = _useState18[0],
      setMaxPageCount = _useState18[1];

  var _useState19 = Object(external_react_["useState"])(''),
      _useState20 = _slicedToArray(_useState19, 2),
      words = _useState20[0],
      setWords = _useState20[1];

  var _useState21 = Object(external_react_["useState"])(0),
      _useState22 = _slicedToArray(_useState21, 2),
      wordsCount = _useState22[0],
      setWordsCount = _useState22[1];
  ...
  Object(external_react_["useEffect"])(function () {
    Promise.all([Object(helpers["c" /* getData */])('data/words/index.json'), Object(helpers["c" /* getData */])('data/pages/words.json')]).then(function (_ref2) {
      var _ref3 = _slicedToArray(_ref2, 2),
          data = _ref3[0],
          wordsPageData = _ref3[1];

      var currentPage = router && router.query && router.query.page || 1;
      setCurrentPage(currentPage);

      var _getAllColours = Object(helpers["b" /* getAllColours */])(Object(helpers["g" /* getMenuColour */])(data)),
          _getAllColours2 = _slicedToArray(_getAllColours, 3),
      ...
      setImage(Object(helpers["d" /* getFullUrl */])(wordsPageData.header.image));
      ...
      var words = Object.values(data).map(function (word) {
        ...
        return Object(external_date_fns_["compareAsc"])(new Date(b.date), new Date(a.date));
      });
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", {
    key: "title"
  }, "Words - Gateway Church, York")), external_react_default.a.createElement(Header["a" /* default */], {
    colour: colour,
    colourHex: colourHex,
  ...
  }), subtitle && subtitle.subtitle && external_react_default.a.createElement(PageSummary["a" /* default */], {
    color: colourHex
  }, subtitle.subtitle), external_react_default.a.createElement(Container["a" /* default */], null, maxPageCount > 1 && external_react_default.a.createElement(PaginationWords, {
    color: colourHex
  }, external_react_default.a.createElement(components_Pagination, {
    maxCount: maxPageCount,
    currentPage: currentPage
  })), external_react_default.a.createElement("ul", null, words.map(function (word) {
    var authors = word.authors && word.authors.map(function (_ref4) {
      var author = _ref4.author;
      return author.trim();
    }).filter(function (author) {
      return author;
    });
    return external_react_default.a.createElement(WordWords, {
      key: word.title
    }, external_react_default.a.createElement(router_0["Link"], {
      href: "/words/".concat(word.slug),
      passHref: true
    }, external_react_default.a.createElement(LinkWords, {
      colour: Object(helpers["a" /* changeColourToHex */])(word.colour, true)
    }, external_react_default.a.createElement(TextContainerWords, null, external_react_default.a.createElement(TextWords, null, external_react_default.a.createElement(DateWords, {
      colour: Object(helpers["a" /* changeColourToHex */])(word.colour)
    }, Object(external_date_fns_["format"])(word.date, 'EEEE do LLLL yyyy'), authors && authors.length > 0 && external_react_default.a.createElement(external_react_default.a.Fragment, null, authors.map(function (author) {
      return external_react_default.a.createElement(external_react_default.a.Fragment, {
        key: author
      }, ' - ', author.split('-').map(function (word) {
        return word[0].toUpperCase() + word.substr(1);
      }).join(' '));
    }))), external_react_default.a.createElement(H2Words, null, word.title.split('-').map(function (word) {
      return word[0].toUpperCase() + word.substr(1);
    }).join(' ')), external_react_default.a.createElement(components_Subtitle, null, word.subtitle)), external_react_default.a.createElement(ReadMoreWords, {
      colour: Object(helpers["a" /* changeColourToHex */])(word.colour)
    }, "Read More +")), external_react_default.a.createElement(HideOnMobileWords, null, external_react_default.a.createElement(ImageWrapperWords, {
      colour: Object(helpers["a" /* changeColourToHex */])(word.colour),
      marginBottom: 0
    }, external_react_default.a.createElement(Image["a" /* default */], {
      url: Object(helpers["d" /* getFullUrl */])(word.image)
    }))), external_react_default.a.createElement(Clearfix["a" /* default */], null))));
  }))), external_react_default.a.createElement(Footer["a" /* default */], null));
};

/* harmony default export */ var pages_words = __webpack_exports__["default"] = (Object(router_["withRouter"])(words_Words));
