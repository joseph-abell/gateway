...
// CONCATENATED MODULE: ./components/Deck.js
function _templateObject3() {
...
var Text = external_styled_components_default.a.div(_templateObject(), function (props) {
  return props.colour;
});
var Image = external_styled_components_default.a.div(_templateObject2(), function (props) {
  return props.src;
});
var ImageWrapper = external_styled_components_default.a.div(_templateObject3());

var Deck_Deck = function Deck(_ref) {
  var colour = _ref.colour,
      text = _ref.text,
      image = _ref.image;

  if (image) {
    return external_react_default.a.createElement("div", null, external_react_default.a.createElement(Text, {
      colour: colour
    }, text), external_react_default.a.createElement(ImageWrapper, null, external_react_default.a.createElement(Image, {
      src: image
    })));
  }
...
function _templateObject13() {
  var data = people_taggedTemplateLiteral(["\n  margin: 0 20px 20px;\n"]);
...
function people_templateObject3() {
  var data = people_taggedTemplateLiteral(["\n  font-size: 30px;\n  line-height: 76px;\n"]);

  people_templateObject3 = function _templateObject3() {
    return data;
  };
...
function people_templateObject2() {
  var data = people_taggedTemplateLiteral(["\n  font-size: 30px;\n  line-height: 76px;\n  padding: 0 30px;\n  background-color: ", ";\n  color: white;\n  margin-bottom: 20px;\n"]);

  people_templateObject2 = function _templateObject2() {
    return data;
  };
...
function people_templateObject() {
  var data = people_taggedTemplateLiteral(["\n  padding: 0 30px;\n  color: white;\n  background-color: ", ";\n  display: block;\n  height: 300px;\n"]);

  people_templateObject = function _templateObject() {
    return data;
  };
...
function people_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var StyledLink = external_styled_components_default.a.a(people_templateObject(), function (props) {
  return props.colour;
});
var FilterTitle = external_styled_components_default.a.h1(people_templateObject2(), function (props) {
  return props.colour;
});
var FilterItemTitle = external_styled_components_default.a.h2(people_templateObject3());
var FilterItemDeck = external_styled_components_default.a.p(_templateObject4());
var PersonBlock = external_styled_components_default.a.div(_templateObject5(), function (props) {
  return props.colour;
});
var Padding = external_styled_components_default.a.div(_templateObject6());
var Email = external_styled_components_default.a.p(_templateObject7());
var Filter = external_styled_components_default.a.li(_templateObject8());
var Person = external_styled_components_default.a.li(_templateObject9());
var PersonTitle = external_styled_components_default.a.h2(_templateObject10());
var PersonRole = external_styled_components_default.a.p(_templateObject11());
var H1 = external_styled_components_default.a.h1(_templateObject12(), function (props) {
  return props.colour;
});
var P = external_styled_components_default.a.p(_templateObject13());

var people_NoPeopleFound = function NoPeopleFound(_ref) {
  var colourHex = _ref.colourHex,
      filter = _ref.filter;
  return external_react_default.a.createElement("main", null, external_react_default.a.createElement(Container["a" /* default */], null, external_react_default.a.createElement(H1, {
    colour: colourHex
  }, "No People found"), external_react_default.a.createElement(P, null, "No people matching the filter ", filter, " found.")));
};

var people_PeopleFilters = function PeopleFilters(_ref2) {
  ...
  return external_react_default.a.createElement("main", null, external_react_default.a.createElement(components_Deck, {
    colour: deckColour,
    text: deckParagraph,
    image: deckImage
  }), external_react_default.a.createElement(Container["a" /* default */], null, external_react_default.a.createElement(FilterTitle, {
    colour: colourHexLight
  }, "Filter By"), external_react_default.a.createElement("ul", null, acceptedFilters.map(function (filter) {
    return external_react_default.a.createElement(Filter, {
      key: filter.name
    ...
    }, external_react_default.a.createElement(FilterItemTitle, null, filter.title.split('-').map(function (word) {
      return word[0].toUpperCase() + word.substr(1);
    }).join(' ')), external_react_default.a.createElement(FilterItemDeck, null, filter.deck))));
  })), external_react_default.a.createElement(Clearfix["a" /* default */], null)));
};

var people_PeopleList = function PeopleList(_ref3) {
  var colourHex = _ref3.colourHex,
      people = _ref3.people,
      filter = _ref3.filter;
  return external_react_default.a.createElement("main", null, external_react_default.a.createElement(Container["a" /* default */], null, external_react_default.a.createElement(H1, {
    colour: colourHex
  }, "People: ", filter), external_react_default.a.createElement("ul", null, people.map(function (person) {
    return external_react_default.a.createElement(Person, {
      key: person.data.title
    }, external_react_default.a.createElement(router_0["Link"], {
      href: "/people/".concat(person.data.title),
      passHref: true
    }, external_react_default.a.createElement("a", null, external_react_default.a.createElement(PersonBlock, {
      colour: Object(helpers["a" /* changeColourToHex */])(person.data.menuColour, true)
    }, external_react_default.a.createElement(components_Image["a" /* default */], {
      url: Object(helpers["d" /* getFullUrl */])(person.data.image)
    })), external_react_default.a.createElement(PersonBlock, {
      colour: Object(helpers["a" /* changeColourToHex */])(person.data.menuColour, true)
    }, external_react_default.a.createElement(Padding, null, external_react_default.a.createElement(PersonTitle, null, person.data.title.split('-').map(function (word) {
      return word[0].toUpperCase() + word.substr(1);
    }).join(' ')), external_react_default.a.createElement(PersonRole, null, person.data.titleRole), external_react_default.a.createElement(Email, null, person.data.email))))));
  }))));
};

var People = Object(router_["withRouter"])(function (_ref4) {
  var _ref4$router = _ref4.router,
      router = _ref4$router === void 0 ? {} : _ref4$router;
  ...
  var _useState7 = Object(external_react_["useState"])(''),
      _useState8 = _slicedToArray(_useState7, 2),
      colour = _useState8[0],
      setColour = _useState8[1];

  var _useState9 = Object(external_react_["useState"])(''),
      _useState10 = _slicedToArray(_useState9, 2),
      colourHex = _useState10[0],
      setColourHex = _useState10[1];

  var _useState11 = Object(external_react_["useState"])(''),
      _useState12 = _slicedToArray(_useState11, 2),
      colourHexLight = _useState12[0],
      setColourHexLight = _useState12[1];

  var _useState13 = Object(external_react_["useState"])(''),
      _useState14 = _slicedToArray(_useState13, 2),
      deckColour = _useState14[0],
      setDeckColour = _useState14[1];

  var _useState15 = Object(external_react_["useState"])(''),
      _useState16 = _slicedToArray(_useState15, 2),
      deckImage = _useState16[0],
      setDeckImage = _useState16[1];

  var _useState17 = Object(external_react_["useState"])(''),
      _useState18 = _slicedToArray(_useState17, 2),
      deckParagraph = _useState18[0],
      setDeckParagraph = _useState18[1];

  var _useState19 = Object(external_react_["useState"])([]),
      _useState20 = _slicedToArray(_useState19, 2),
      people = _useState20[0],
      setPeople = _useState20[1];
  ...
  var _useState23 = Object(external_react_["useState"])([]),
      ...
      acceptedFilters = _useState24[0],
      setAcceptedFilters = _useState24[1];
  ...
  Object(external_react_["useEffect"])(function () {
    ...
    setFilter(filter);
    Promise.all([Object(helpers["c" /* getData */])('data/peopleFilters/index.json'), Object(helpers["c" /* getData */])('data/people/index.json'), Object(helpers["c" /* getData */])('data/pages/people.json')]).then(function (_ref6) {
      var _ref7 = _slicedToArray(_ref6, 3),
          acceptedFilters = _ref7[0],
          workingPeople = _ref7[1],
          data = _ref7[2];
      ...
      setDeckImage(data.deck.image && Object(helpers["d" /* getFullUrl */])(data.deck.image));
      ...
      setAcceptedFilters(Object.values(acceptedFilters).map(function (f) {
        ...
        return {
          ...
          title: f.title,
          deck: f.deck,
          colour: Object(helpers["a" /* changeColourToHex */])(f.colour, true)
        };
      }));
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", {
    key: "title"
  }, "People - Gateway Church, York")), external_react_default.a.createElement(Header["a" /* default */], {
    colour: colour,
    colourHex: colourHex,
    title: title,
    image: image,
    Header: HeaderContainer["a" /* default */]
  }), people.length > 0 && filter && external_react_default.a.createElement(people_PeopleList, {
    colourHex: colourHex,
    people: people,
    filter: filter
  }), filter && people.length === 0 && external_react_default.a.createElement(people_NoPeopleFound, {
    colourHex: colourHex,
    filter: filter
  }), !filter && external_react_default.a.createElement(people_PeopleFilters, {
    colourHexLight: colourHexLight,
    deckColour: deckColour,
    deckParagraph: deckParagraph,
    deckImage: deckImage,
    acceptedFilters: acceptedFilters
  }), external_react_default.a.createElement(Clearfix["a" /* default */], null), external_react_default.a.createElement(Footer["a" /* default */], null));
});
/* harmony default export */ var pages_people = __webpack_exports__["default"] = (People);
