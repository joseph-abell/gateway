...
var StyledLink = external_styled_components_default.a.a(_templateObject3(), function (props) {
  return props.colour;
}, Image["a" /* default */], H2, P);
var Wrapper = external_styled_components_default.a.li(_templateObject4());
var StyledCallToActions = external_styled_components_default.a.ul(_templateObject5());
...
var CallToActions_CallToAction = function CallToAction(_ref) {
  ...
  return external_react_["createElement"](Wrapper, {
    key: title
  }, external_react_["createElement"](router["Link"], {
    href: link
  }, external_react_["createElement"](StyledLink, {
    colour: colour
  }, external_react_["createElement"](Image["a" /* default */], {
    url: image
  }), external_react_["createElement"](H2, null, title), external_react_["createElement"](P, null, deck))));
};

var CallToActions_CallToActions = function CallToActions(_ref2) {
  var cta = _ref2.cta;
  return external_react_["createElement"](StyledCallToActions, null, cta.map(CallToActions_CallToAction));
};
...
function Quotes_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var Blockquote = external_styled_components_default.a.blockquote(Quotes_templateObject());
var Author = external_styled_components_default.a.div(Quotes_templateObject2());
var StyledSlider = external_styled_components_default()(external_react_slick_default.a)(Quotes_templateObject3());
...
var Quotes_Quote = function Quote(_ref) {
  ...
  return external_react_["createElement"]("div", {
    key: quote
  }, external_react_["createElement"](Blockquote, null, quote), external_react_["createElement"](Author, null, author));
};

var Quotes_Quotes = function Quotes(_ref2) {
  var quotes = _ref2.quotes;
  return external_react_["createElement"](StyledSlider, settings, quotes.map(Quotes_Quote));
};
...
function HomeDeck_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var Text = external_styled_components_default.a.div(HomeDeck_templateObject(), function (props) {
  return props.colour;
});
var HomeDeck_Image = external_styled_components_default.a.div(HomeDeck_templateObject2(), function (props) {
  return props.src;
});
...
var HomeDeck_HomeDeck = function HomeDeck(_ref) {
  var colour = _ref.colour,
      text = _ref.text,
      image = _ref.image;
  return external_react_["createElement"](Container["a" /* default */], null, external_react_["createElement"](Text, {
    colour: colour,
    dangerouslySetInnerHTML: {
      __html: text
    }
  }), external_react_["createElement"](ImageWrapper["a" /* default */], {
    mobileHeight: "400px"
...
function SimpleEvents_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var H3 = external_styled_components_default.a.h3(SimpleEvents_templateObject(), function (props) {
  return props.colour;
});
var UL = external_styled_components_default.a.ul(SimpleEvents_templateObject2(), function (props) {
  return props.colour;
});
var LI = external_styled_components_default.a.li(SimpleEvents_templateObject3());
var SimpleEvents_P = external_styled_components_default.a.p(SimpleEvents_templateObject4(), function (props) {
  return props.colour;
});
var SimpleEvents_StyledLink = external_styled_components_default.a.a(SimpleEvents_templateObject5());
var MoreEvents = external_styled_components_default.a.div(_templateObject6(), function (props) {
  return props.colour;
});
var EventsWrapper = external_styled_components_default.a.div(_templateObject7(), function (props) {
  return props.colour;
});
...
var SimpleEvents_SimpleEvents = function SimpleEvents(_ref) {
  ...
  Object(external_react_["useEffect"])(function () {
    Object(helpers["c" /* getData */])('data/events/index.json').then(function (data) {
      ...
      setEvents(events.filter(function (event) {
        ...
        return external_moment_default()(a.dateTime).isAfter(b.dateTime) ? 1 : -1;
      }).filter(function (event) {
        return external_moment_default()().isBefore(event.dateTime);
      }).slice(0, 3));
      setLoading(false);
    });
  }, []);
  if (loading) return external_react_default.a.createElement("div", null);
  return external_react_default.a.createElement(EventsWrapper, {
    colour: colourLight
  }, external_react_default.a.createElement(H3, {
    colour: colour
  }, "Events"), external_react_default.a.createElement(UL, {
    colour: colourLight
    ...
    }, external_react_default.a.createElement(SimpleEvents_StyledLink, null, external_react_default.a.createElement(SimpleEvents_P, {
      colour: colour
    }, external_moment_default()(event.dateTime).format('dddd MMM Do YYYY')), external_react_default.a.createElement("p", null, event.title.split('-').map(function (word) {
      return word[0].toUpperCase() + word.substr(1);
    }).join(' ')), external_react_default.a.createElement("p", null, external_moment_default()(event.dateTime).format('kk:mm')))));
  })), external_react_default.a.createElement(MoreEvents, {
    colour: colourLight
  }, external_react_default.a.createElement(router["Link"], {
    href: "/events"
  }, external_react_default.a.createElement(SimpleEvents_StyledLink, null, "More Events"))));
};

/* harmony default export */ var components_SimpleEvents = (SimpleEvents_SimpleEvents);
// CONCATENATED MODULE: ./pages/index.js
function pages_slicedToArray(arr, i) { return pages_arrayWithHoles(arr) || pages_iterableToArrayLimit(arr, i) || pages_nonIterableRest(); }

function pages_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function pages_iterableToArrayLimit(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
var Padding = external_styled_components_default.a.div(pages_templateObject());
var StyledImageWrapper = external_styled_components_default()(ImageWrapper["a" /* default */])(pages_templateObject2());
...
var TwitterWrapper = external_styled_components_default.a.div(pages_templateObject3(), function (props) {
  return props.colour;
}, function (props) {
  return props.mobileMarginBottom || '20px';
});
...
var pages_Home = function Home() {
  ...
  var _useState9 = Object(external_react_["useState"])(''),
      ...
      deckColour = _useState10[0],
      setDeckColour = _useState10[1];

  var _useState11 = Object(external_react_["useState"])(''),
      _useState12 = pages_slicedToArray(_useState11, 2),
      deckText = _useState12[0],
      setDeckText = _useState12[1];
  ...
  var _useState17 = Object(external_react_["useState"])(''),
      _useState18 = pages_slicedToArray(_useState17, 2),
      colourHexLight = _useState18[0],
      setColourHexLight = _useState18[1];

  var _useState19 = Object(external_react_["useState"])([]),
      _useState20 = pages_slicedToArray(_useState19, 2),
      cta = _useState20[0],
      setCta = _useState20[1];

  var _useState21 = Object(external_react_["useState"])(''),
      _useState22 = pages_slicedToArray(_useState21, 2),
      eventsImage = _useState22[0],
      setEventsImage = _useState22[1];

  var _useState23 = Object(external_react_["useState"])(''),
      _useState24 = pages_slicedToArray(_useState23, 2),
      twitterImage = _useState24[0],
      setTwitterImage = _useState24[1];

  var _useState25 = Object(external_react_["useState"])([]),
      _useState26 = pages_slicedToArray(_useState25, 2),
      quotes = _useState26[0],
      setQuotes = _useState26[1];

  Object(external_react_["useEffect"])(function () {
    Object(helpers["c" /* getData */])('data/homepage.json').then(function (data) {
      setTitle(data.header.title);
      setImage(data.header.image);
      setDeckImage(Object(helpers["d" /* getFullUrl */])(data.deck.image));
      setDeckColour(Object(helpers["a" /* changeColourToHex */])(data.deck.colour));
      setDeckText(data.deck.text);

      var _getAllColours = Object(helpers["b" /* getAllColours */])(Object(helpers["g" /* getMenuColour */])(data)),
          _getAllColours2 = pages_slicedToArray(_getAllColours, 3),
      ...
      setEventsImage(Object(helpers["d" /* getFullUrl */])(data.eventsImage));
      setTwitterImage(Object(helpers["d" /* getFullUrl */])(data.twitterImage));
      setQuotes(data.quotes);
      setCta(data.cta.map(function (item) {
        item.image = Object(helpers["d" /* getFullUrl */])(item.image);
        item.colour = Object(helpers["a" /* changeColourToHex */])(item.colour);
        return item;
      }));
      setLoading(false);
    });
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", {
    key: "title"
  }, "Gateway Church, York")), external_react_default.a.createElement(Header["a" /* default */], {
    colour: colour,
    colourHex: colourHex,
  ...
  }), external_react_default.a.createElement("main", null, external_react_default.a.createElement(components_CallToActions, {
    cta: cta
  }), external_react_default.a.createElement(Padding, null, external_react_default.a.createElement(components_Quotes, {
    quotes: quotes
  }), external_react_default.a.createElement(components_HomeDeck, {
    colour: deckColour,
    text: deckText,
    image: deckImage
  }), external_react_default.a.createElement(Container["a" /* default */], null, external_react_default.a.createElement(StyledImageWrapper, {
    mobileHeight: "400px",
    mobileMarginBottom: "0"
  }, external_react_default.a.createElement(Image["a" /* default */], {
    url: eventsImage
  })), external_react_default.a.createElement(components_SimpleEvents, {
    colour: colourHex,
    colourLight: colourHexLight
  }), external_react_default.a.createElement(Clearfix["a" /* default */], null)), external_react_default.a.createElement(Container["a" /* default */], null, external_react_default.a.createElement(TwitterWrapper, {
    colour: colourHex
  }, external_react_default.a.createElement("a", {
    className: "twitter-timeline",
    "data-height": "400",
    href: "https://twitter.com/gatewayyork?ref_src=twsrc%5Etfw"
  }, "Tweets by gatewayyork"), external_react_default.a.createElement("script", {
    dangerouslySetInnerHTML: twitter(),
    async: true,
    src: "https://platform.twitter.com/widgets.js",
    charSet: "utf-8"
  })), external_react_default.a.createElement(ImageWrapper["a" /* default */], {
    mobileHeight: "400px"
  }, external_react_default.a.createElement(Image["a" /* default */], {
    url: twitterImage
