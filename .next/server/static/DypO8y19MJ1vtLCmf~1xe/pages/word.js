...
var external_react_sound_default = /*#__PURE__*/__webpack_require__.n(external_react_sound_);
...
var AudioPlayer = external_styled_components_default.a.div(_templateObject(), function (props) {
  return props.colour;
});
var Button = external_styled_components_default.a.button(_templateObject2());
var SliderContainer = external_styled_components_default.a.div(_templateObject3());
var StyledSlider = external_styled_components_default()(Slider_default.a)(_templateObject4(), function (props) {
  return props.colour;
}, function (props) {
  return props.colour;
});
var Download = external_styled_components_default.a.a(_templateObject5(), function (props) {
  return props.colour;
});
...
function (_React$Component) {
  ...
  function Audio() {
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      return external_react_default.a.createElement(AudioPlayer, {
        colour: _this.props.colour
      }, external_react_default.a.createElement(external_react_sound_default.a, {
        url: _this.props.url,
        ...
        src: Object(helpers["d" /* getFullUrl */])('/uploads/rewind.png')
      })), external_react_default.a.createElement(Button, {
        onClick: _this.togglePlayPause
      }, _this.state.playStatus === 'PLAYING' && external_react_default.a.createElement("img", {
        src: Object(helpers["d" /* getFullUrl */])('/uploads/pause.png')
      }), _this.state.playStatus === 'PAUSED' && external_react_default.a.createElement("img", {
        src: Object(helpers["d" /* getFullUrl */])('/uploads/play.png')
      }), _this.state.playStatus === 'STOPPED' && external_react_default.a.createElement("img", {
        src: Object(helpers["d" /* getFullUrl */])('/uploads/play.png')
      })), external_react_default.a.createElement(Button, {
        onClick: _this.pressFastForward
      }, external_react_default.a.createElement("img", {
        src: Object(helpers["d" /* getFullUrl */])('/uploads/fast-forward.png')
      })), external_react_default.a.createElement(Download, {
        href: _this.props.url,
        colour: _this.props.lightColour
      }, external_react_default.a.createElement("img", {
        src: Object(helpers["d" /* getFullUrl */])('/uploads/download.png')
      })), external_react_default.a.createElement(SliderContainer, null, external_react_default.a.createElement("img", {
        src: Object(helpers["d" /* getFullUrl */])('/uploads/volume.png')
      }), external_react_default.a.createElement(StyledSlider, {
        onChange: _this.handleVolumeChange,
        defaultValue: 100,
        colour: _this.props.lightColour
      }), external_react_default.a.createElement(Clearfix["a" /* default */], null)), external_react_default.a.createElement(Clearfix["a" /* default */], null));
    });
...
function H1Word_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
function H2Word_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
function PWord_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
function DeckWord_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var Deck = external_styled_components_default.a.div(DeckWord_templateObject(), function (props) {
  return props.colour;
});
...
function DateWord_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var StyledDate = external_styled_components_default.a.div(DateWord_templateObject(), function (props) {
  return props.colour;
});
...
function LinkWord_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


var Link = external_styled_components_default.a.a(LinkWord_templateObject(), function (props) {
  return props.colour;
});
...
function word_templateObject() {
  var data = word_taggedTemplateLiteral(["\n  line-height: 1.5em;\n\n  p {\n    margin-bottom: 20px;\n  }\n\n  a {\n    color: ", ";\n  }\n"]);

  word_templateObject = function _templateObject() {
    return data;
  };
...
function word_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var WordText = external_styled_components_default.a.div(word_templateObject(), function (props) {
  return props.colour;
});
...
var word_Word = function Word(_ref) {
  ...
  var _useState17 = Object(external_react_["useState"])(''),
      ...
      audioFile = _useState18[0],
      setAudioFile = _useState18[1];

  var _useState19 = Object(external_react_["useState"])(''),
      _useState20 = _slicedToArray(_useState19, 2),
      deck = _useState20[0],
      setDeck = _useState20[1];

  var _useState21 = Object(external_react_["useState"])(''),
      _useState22 = _slicedToArray(_useState21, 2),
      youtubeLink = _useState22[0],
      setYoutubeLink = _useState22[1];

  var _useState23 = Object(external_react_["useState"])(''),
      _useState24 = _slicedToArray(_useState23, 2),
      file = _useState24[0],
      setFile = _useState24[1];

  var _useState25 = Object(external_react_["useState"])([]),
      _useState26 = _slicedToArray(_useState25, 2),
      authors = _useState26[0],
      setAuthors = _useState26[1];

  Object(external_react_["useEffect"])(function () {
    var id = router.query.id;
    id = id.split(' ').join('-').split(':').join('').toLowerCase();
    Object(helpers["c" /* getData */])("data/words/".concat(id, ".json")).then(function (data) {
      var audioFile = data.audioFile;

      if (!audioFile || !audioFile.includes('.mp3')) {
        audioFile = '';
      } else {
        audioFile = Object(helpers["d" /* getFullUrl */])(audioFile);
      }
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", {
    key: "title"
  }, title, " - Gateway Church, York")), external_react_default.a.createElement(Header["a" /* default */], {
    colour: colour,
    colourHex: colourHex,
    colourHexLight: colourHexLight,
    Header: HeaderContainer["a" /* default */]
  }), external_react_default.a.createElement(DeckWord, {
    colour: colourHexLight
  }, external_react_default.a.createElement(Container["a" /* default */], null, external_react_default.a.createElement(DateWord, {
    colour: colourHex
  }, date && Object(external_date_fns_["format"])(date, 'EEEE do LLLL yyyy'), ' ', authors && authors.map(function (_ref2) {
    var author = _ref2.author;
    return external_react_default.a.createElement(external_react_default.a.Fragment, null, ' - ', external_react_default.a.createElement(LinkWord, {
      colour: colourHex,
      href: '/people/' + author.toLowerCase().split(' ').join('-')
    }, author.split('-').map(function (word) {
      return word[0].toUpperCase() + word.substr(1);
    }).join(' ')));
  })), external_react_default.a.createElement(H1Word, null, title && title.split('-').map(function (word) {
    return word[0].toUpperCase() + word.substr(1);
  }).join(' ')), external_react_default.a.createElement(H2Word, null, subtitle))), external_react_default.a.createElement(Container["a" /* default */], null, image && external_react_default.a.createElement(ImageWrapper["a" /* default */], null, external_react_default.a.createElement(Image["a" /* default */], {
    url: Object(helpers["d" /* getFullUrl */])() + image.slice(1)
  })), audioFile && external_react_default.a.createElement(PWord, null, external_react_default.a.createElement(components_Audio, {
    url: audioFile,
    colour: colourHex,
    lightColour: colourHexLight
  })), file && file.endsWith('mp3') && external_react_default.a.createElement(PWord, null, external_react_default.a.createElement(components_Audio, {
    url: Object(helpers["d" /* getFullUrl */])(file),
    colour: colourHex,
    lightColour: colourHexLight
  })), deck && deck.startsWith('<') && external_react_default.a.createElement(WordText, {
    ...
    colour: colourHex
  }), youtubeLink && external_react_default.a.createElement(PWord, null, external_react_default.a.createElement(LinkWord, {
    colour: colourHex,
    href: youtubeLink
  }, youtubeLink)), file && !file.includes('mp3') && external_react_default.a.createElement(PWord, null, external_react_default.a.createElement(LinkWord, {
    colour: colourHex,
    href: Object(helpers["d" /* getFullUrl */])(file)
  }, file.replace('/uploads/', '')))), external_react_default.a.createElement(Footer["a" /* default */], null));
};

/* harmony default export */ var word = __webpack_exports__["default"] = (Object(router_["withRouter"])(word_Word));
