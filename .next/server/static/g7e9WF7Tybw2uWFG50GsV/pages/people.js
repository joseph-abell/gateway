module.exports = /******/ (function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      var ImageWrapper = external_styled_components_default.a.div(
        _templateObject3()
      );
      ...
      var components_Image = __webpack_require__(15);
      ...
      function people_taggedTemplateLiteral(strings, raw) {
        if (!raw) {
          raw = strings.slice(0);
        }
        return Object.freeze(
      ...
      var StyledLink = external_styled_components_default.a.a(
        people_templateObject(),
        function(props) {
          return props.colour;
        }
      );
      var FilterTitle = external_styled_components_default.a.h1(
        people_templateObject2(),
        function(props) {
          return props.colour;
        }
      );
      var FilterItemTitle = external_styled_components_default.a.h2(
        people_templateObject3()
      );
      var FilterItemDeck = external_styled_components_default.a.p(
        _templateObject4()
      );
      var PersonBlock = external_styled_components_default.a.div(
        _templateObject5(),
        function(props) {
          return props.colour;
        }
      ...
      var PersonTitle = external_styled_components_default.a.h2(
        _templateObject10()
      );
      var PersonRole = external_styled_components_default.a.p(
        _templateObject11()
      );
      var H1 = external_styled_components_default.a.h1(
        _templateObject12(),
        function(props) {
          return props.colour;
        }
          ...
          external_react_promise_default.a,
          {
                        ...
                        while (1) {
                          switch ((_context.prev = _context.next)) {
                            ...
                            case 16:
                              ...
                              (deck = data.deck), (header = data.header);
                              deck.image =
                                deck &&
                                deck.image &&
                                Object(helpers['c' /* getFullUrl */])(
                                  deck.image
                                );
                              deck.colour = Object(
                                helpers['a' /* changeColourToHex */]
            ...
            then: function then(_ref4) {
              var title = _ref4.title,
                ...
                people = _ref4.people,
                filter = _ref4.filter,
                acceptedFilters = _ref4.acceptedFilters;
                              ...
                              external_react_default.a.createElement(
                                ...
                                external_react_default.a.createElement(
                                  PersonBlock,
                                  {
                                    colour: Object(
                                      helpers['a' /* changeColourToHex */]
                                    )(person.data.menuColour, true)
                                  },
                                  external_react_default.a.createElement(
                                    components_Image['a' /* default */],
                                    {
                                      url: Object(
              ...
              return external_react_default.a.createElement(
                ...
                external_react_default.a.createElement(
                  'main',
                  null,
                  external_react_default.a.createElement(components_Deck, {
                    colour: deck.colour,
                    text: deck.paragraph,
                    image: deck.image
                  }),
      ...
      /* harmony default export */ var pages_people = (__webpack_exports__[
        'default'
      ] = People);
