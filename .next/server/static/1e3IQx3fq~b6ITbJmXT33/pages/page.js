...
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(18);
...
/* harmony import */ var _helpers_config__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6);
/* harmony import */ var _templates_Header__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(10);
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(3);
...
var ImageWrapper = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div(_templateObject(), function (props) {
  return props.color;
});
var Deck = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div(_templateObject2());
var PageSummary = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div(_templateObject3(), function (props) {
  return props.color;
});
...
var ContentPiece = function ContentPiece(_ref) {
  ...
  if (image) {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ImageWrapper, {
      className: direction,
      color: colour
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Image__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"], {
      url: Object(_helpers__WEBPACK_IMPORTED_MODULE_10__[/* getFullUrl */ "c"])(image)
    }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Deck, null, deck));
  }
...
var Content = function Content(_ref2) {
  ...
  if (right.deck && !left.deck) {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("li", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContentPiece, {
      direction: "right",
      deck: right.deck,
      image: right.image,
      colour: right.colour
    }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContentPiece, {
      direction: "left",
      deck: left.deck,
      image: left.image,
      colour: left.colour
...
var Contents = function Contents(_ref3) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("ul", null, contents && contents.map(function (_ref4) {
...
var Page = Object(next_router__WEBPACK_IMPORTED_MODULE_4__["withRouter"])(function (_ref5) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_promise__WEBPACK_IMPORTED_MODULE_2___default.a, {
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(resolve, reject) {
        var data, _data, title, _data$header, header, _data$subtitle, subtitle, deck, contents, image, menuColour, colourHex, subtitleText, subtitleImage, deckTitle, deckParagraph, deckColour;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return Object(_helpers__WEBPACK_IMPORTED_MODULE_10__[/* getData */ "b"])("data/pages/".concat(pathname, ".json"));
              ...
              case 11:
                _data = data, title = _data.title, _data$header = _data.header, header = _data$header === void 0 ? {} : _data$header, _data$subtitle = _data.subtitle, subtitle = _data$subtitle === void 0 ? {} : _data$subtitle, deck = _data.deck, contents = _data.contents;
                image = header.image, menuColour = header.menuColour;
                colourHex = Object(_helpers__WEBPACK_IMPORTED_MODULE_10__[/* changeColourToHex */ "a"])(menuColour);
                subtitleText = subtitle.subtitle;
                subtitleImage = subtitle && subtitle.image && _helpers_config__WEBPACK_IMPORTED_MODULE_6__[/* url */ "a"] + subtitle.image.slice(1);
                deckTitle = deck && deck.title;
                deckParagraph = deck && deck.paragraph;
                deckColour = deck && deck.colour;
                resolve({
                  title: title,
                  image: image && _helpers_config__WEBPACK_IMPORTED_MODULE_6__[/* url */ "a"] + image.slice(1),
    ...
    then: function then(_ref7) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_templates_Header__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"], {
        colour: menuColour,
        colourHex: colourHex,
        title: title,
        image: image,
        Header: _components_HeaderContainer__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"]
      }), subtitleImage && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ImageWrapper, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Image__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"], {
        url: subtitleImage
      })), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(PageSummary, {
        color: colourHex
      }, subtitleText), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Contents, {
        contents: contents
      }));
    },
    catch: function _catch() {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, _router__WEBPACK_IMPORTED_MODULE_5__["Router"].replaceRoute('/404'));
    }
  });
});
