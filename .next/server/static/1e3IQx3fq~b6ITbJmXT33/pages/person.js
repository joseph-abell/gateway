...
/* harmony import */ var _templates_Header__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(10);
/* harmony import */ var _components_HeaderContainer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(11);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3);
...
var Container = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div(_templateObject(), function (props) {
  return props.colour;
});
var H1 = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.h1(_templateObject2());
var H2 = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.h2(_templateObject3());
var Person = Object(next_router__WEBPACK_IMPORTED_MODULE_4__["withRouter"])(function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_promise__WEBPACK_IMPORTED_MODULE_2___default.a, {
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(resolve) {
        var query, pathname, data, colour, colourHex, colourHexLight, title, image, deck, email, phoneNumber, titleRole, filters;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = router.query;
                pathname = query.id.split(' ').join('-').toLowerCase();
                _context.next = 4;
                return Object(_helpers__WEBPACK_IMPORTED_MODULE_7__[/* getData */ "b"])("data/people/".concat(pathname, ".json"));

              case 4:
                data = _context.sent;
                colour = Object(_helpers__WEBPACK_IMPORTED_MODULE_7__[/* getMenuColour */ "f"])(data);
                colourHex = Object(_helpers__WEBPACK_IMPORTED_MODULE_7__[/* changeColourToHex */ "a"])(colour);
                colourHexLight = Object(_helpers__WEBPACK_IMPORTED_MODULE_7__[/* changeColourToHex */ "a"])(colour, true);
                title = data.title, image = data.image, deck = data.deck, email = data.email, phoneNumber = data.phoneNumber, titleRole = data.titleRole, filters = data.filters;
                resolve({
                  title: title,
                  image: image,
                  deck: deck,
    ...
    then: function then(_ref3) {
      var title = _ref3.title,
          ...
          titleRole = _ref3.titleRole,
          filter = _ref3.filter,
          colour = _ref3.colour,
          colourHex = _ref3.colourHex,
          colourHexLight = _ref3.colourHexLight;
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_templates_Header__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
        colour: colour,
        colourHex: colourHex,
        Header: _components_HeaderContainer__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"]
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container, {
        colour: colourHexLight
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(H1, null, title), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(H2, null, titleRole), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, deck)));
    }
  });
});
