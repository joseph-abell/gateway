...
var HideOnMobile = styled_components__WEBPACK_IMPORTED_MODULE_0___default.a.div(_templateObject());
/* harmony default export */ __webpack_exports__["a"] = (HideOnMobile);
...
var CallToActions_CallToActions = function CallToActions(_ref2) {
  var cta = _ref2.cta;
  return external_react_["createElement"]("ul", {
...
var external_react_slick_ = __webpack_require__(24);
...
// EXTERNAL MODULE: ./components/HideOnMobile.js
var HideOnMobile = __webpack_require__(21);

// CONCATENATED MODULE: ./components/HomeDeck.js
function HomeDeck_templateObject3() {
  var data = HomeDeck_taggedTemplateLiteral(["\n\tposition: relative;\n\tmin-height: 200px;\n"]);

  HomeDeck_templateObject3 = function _templateObject3() {
    return data;
  };
...
var ImageWrapper = external_styled_components_default.a.div(HomeDeck_templateObject3());

var HomeDeck_HomeDeck = function HomeDeck(_ref) {
  var colour = _ref.colour,
      text = _ref.text,
      image = _ref.image;
  return external_react_["createElement"]("div", null, external_react_["createElement"](Text, {
    colour: colour
  }, text), external_react_["createElement"](HideOnMobile["a" /* default */], null, external_react_["createElement"](ImageWrapper, null, external_react_["createElement"](HomeDeck_Image, {
    src: image
  }))));
};
...
var SimpleEvents_StyledLink = external_styled_components_default.a.a(_templateObject5());
        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(helpers["b" /* getData */])('data/events/index.json');
    ...
    then: function then(_ref3) {
      ...
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(H3, {
        ...
        return external_react_default.a.createElement(LI, {
          ...
          colour: colour
        }, external_moment_default()(event.dateTime).format('dddd MMM Do YYYY')), external_react_default.a.createElement("p", null, event.title), external_react_default.a.createElement("p", null, external_moment_default()(event.dateTime).format('kk:mm')))));
...
var pages_ImageWrapper = external_styled_components_default.a.div(pages_templateObject2());
...
var pages_Home = function Home() {
  return external_react_default.a.createElement(external_react_promise_default.a, {
    ...
    function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(resolve) {
        var data, colour, colourHex, colourHexLight, quotes, deck, header, eventsImage, cta;
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(helpers["b" /* getData */])('data/homepage.json');

              case 2:
                data = _context.sent;
                colour = Object(helpers["f" /* getMenuColour */])(data);
                colourHex = Object(helpers["a" /* changeColourToHex */])(colour);
                colourHexLight = Object(helpers["a" /* changeColourToHex */])(colour, true);
                quotes = data.quotes, deck = data.deck, header = data.header, eventsImage = data.eventsImage;
                cta = data.cta;
                header.image = Object(helpers["c" /* getFullUrl */])(header.image);
                cta = cta.map(function (item) {
                  item.image = Object(helpers["c" /* getFullUrl */])(item.image);
                  item.colour = Object(helpers["a" /* changeColourToHex */])(item.colour);
                  return item;
                });
                deck.image = Object(helpers["c" /* getFullUrl */])(deck.image);
                deck.colour = Object(helpers["a" /* changeColourToHex */])(deck.colour);
                resolve({
                  header: header,
                  colour: colour,
                  colourHex: colourHex,
                  ...
                  quotes: quotes,
                  deck: deck,
                  eventsImage: Object(helpers["c" /* getFullUrl */])(eventsImage)
                });
    ...
    then: function then(_ref2) {
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(Header["a" /* default */], {
        ...
        text: deck.text,
        image: deck.image
      }), external_react_default.a.createElement(pages_ImageWrapper, null, external_react_default.a.createElement(Image["a" /* default */], {
        url: eventsImage
