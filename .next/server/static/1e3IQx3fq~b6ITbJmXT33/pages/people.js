...
var People = Object(router_["withRouter"])(function (_ref) {
  ...
  return external_react_default.a.createElement(external_react_promise_default.a, {
    ...
    function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(resolve) {
        var _ref3, query, filter, acceptedFilters, people, data, colour, colourHex, colourHexLight, deck, header, title, image;

        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _ref3 = router || {}, query = _ref3.query;
                filter = query.filter; // make a list of filters that we want

                _context.next = 4;
                return Object(helpers["b" /* getData */])('data/peopleFilters/index.json');

              case 4:
                acceptedFilters = _context.sent;
                acceptedFilters = Object.values(acceptedFilters).map(function (f) {
                  return f.data;
                }).map(function (f) {
                  return {
                    name: f.name,
                ...
                people = []; // if the filter is in the list of accepted filters, go ahead

                if (!(filter && acceptedFilters.map(function (f) {
                  return f.name;
                }).includes(filter))) {
                  _context.next = 13;
                  break;
                ...
                _context.next = 10;
                return Object(helpers["b" /* getData */])('data/people/index.json');

              case 10:
                people = _context.sent;
                // we turn the data into what we care about, a list of people information
                people = Object.values(people); // filter the list into only people that match the filter

                people = people.filter(function (person) {
                  // get data from person
                  var _ref4 = person || {},
                      data = _ref4.data; // get filters from data


                  var _ref5 = data || {},
                      filters = _ref5.filters; // get the part of the filters we care about, the keys


                  var keys = Object.keys(filters); // check whether the filter is in the list of keys
              ...
              case 13:
                _context.next = 15;
                return Object(helpers["b" /* getData */])('/data/pages/people.json');
              ...
              case 15:
                ...
                deck = data.deck, header = data.header, title = data.title;
                image = Object(helpers["c" /* getFullUrl */])(header.image);
                deck.image = deck && deck.image && Object(helpers["c" /* getFullUrl */])(deck.image);
                deck.colour = Object(helpers["a" /* changeColourToHex */])(deck && deck.colour);
                resolve({
                  title: title,
                  image: image,
                  colour: colour,
    ...
    then: function then(_ref6) {
      var title = _ref6.title,
          ...
          colourHexLight = _ref6.colourHexLight,
          deck = _ref6.deck,
          people = _ref6.people,
          acceptedFilters = _ref6.acceptedFilters;
      ...
      if (people.length) {
        ...
        }), external_react_default.a.createElement("main", null, external_react_default.a.createElement("ul", null, people.map(function (person) {
          return external_react_default.a.createElement("li", {
            ...
            url: Object(helpers["c" /* getFullUrl */])(person.data.image)
          })), external_react_default.a.createElement(PersonBlock, {
            colour: Object(helpers["a" /* changeColourToHex */])(person.data.menuColour, true)
          }, external_react_default.a.createElement(Padding, null, external_react_default.a.createElement("h2", null, person.data.title), external_react_default.a.createElement("p", null, person.data.titleRole), external_react_default.a.createElement(Email, null, person.data.email))))));
        }))));
      }
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(Header["a" /* default */], {
        ...
        image: image,
        Header: HeaderContainer["a" /* default */]
      }), external_react_default.a.createElement("main", null, external_react_default.a.createElement(components_Deck, {
        colour: deck.colour,
        text: deck.paragraph,
        image: deck.image
      }), external_react_default.a.createElement(FilterTitle, {
        ...
        }, external_react_default.a.createElement(FilterItemTitle, null, filter.title), external_react_default.a.createElement(FilterItemDeck, null, filter.deck))));
