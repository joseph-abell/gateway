...
var Slider_ = __webpack_require__(26);
...
function (_React$Component) {
  ...
  function Audio() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "render", function () {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(external_react_sound_default.a, {
        url: _this.props.url,
      ...
      }, "Play / Pause"), external_react_default.a.createElement("div", {
        onClick: _this.pressFastForward
      }, "Fast Forward"), external_react_default.a.createElement("a", {
        href: _this.props.url
      }, "Download"), external_react_default.a.createElement(Slider_default.a, {
...
var Deck = external_styled_components_default.a.div(_templateObject(), function (props) {
  return props.colour;
});
var word_Date = external_styled_components_default.a.div(_templateObject2(), function (props) {
  return props.colour;
});
var H1 = external_styled_components_default.a.h1(_templateObject3());
var H2 = external_styled_components_default.a.h2(_templateObject4());
var Word = Object(router_["withRouter"])(function (_ref) {
  ...
  return external_react_default.a.createElement(external_react_promise_default.a, {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                id = query.id;
                _context.next = 4;
                return Object(helpers["b" /* getData */])("data/words/".concat(id, ".json"));
              ...
              case 4:
                ...
                resolve({
                  ...
                  date: date,
                  subtitle: subtitle,
                  audioFile: Object(helpers["c" /* getFullUrl */])(audioFile),
                  file: file,
    ...
    then: function then(_ref3) {
      ...
      }), external_react_default.a.createElement(Deck, {
        colour: colourHexLight
      }, external_react_default.a.createElement(word_Date, {
        colour: colourHex
      }, date), external_react_default.a.createElement(H1, null, title), external_react_default.a.createElement(H2, null, subtitle)), external_react_default.a.createElement(ImageWrapper["a" /* default */], null, external_react_default.a.createElement(Image["a" /* default */], {
        url: config["a" /* url */] + image.slice(1)
      })), external_react_default.a.createElement("div", null, external_react_default.a.createElement(components_Audio, {
        url: audioFile
      })));
    }
  });
});
/* harmony default export */ var word = __webpack_exports__["default"] = (Word);
