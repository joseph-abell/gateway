...
/* harmony import */ var _components_PageSummary__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(20);
/* harmony import */ var _components_Image__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(14);
/* harmony import */ var _components_ImageWrapper__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(19);
/* harmony import */ var _components_HideOnMobile__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(21);
/* harmony import */ var _components_Clearfix__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(9);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(3);
...
var StyledLink = styled_components__WEBPACK_IMPORTED_MODULE_4___default.a.a(_templateObject(), function (props) {
  return props.colour;
});
var StyledText = styled_components__WEBPACK_IMPORTED_MODULE_4___default.a.div(_templateObject2());
var StyledDate = styled_components__WEBPACK_IMPORTED_MODULE_4___default.a.div(_templateObject3(), function (props) {
  return props.colour;
});
var Title = styled_components__WEBPACK_IMPORTED_MODULE_4___default.a.h2(_templateObject4());
var ReadMore = styled_components__WEBPACK_IMPORTED_MODULE_4___default.a.div(_templateObject5(), function (props) {
  return props.colour;
});
var StyledTextContainer = styled_components__WEBPACK_IMPORTED_MODULE_4___default.a.div(_templateObject6());
var StyledHideOnMobile = styled_components__WEBPACK_IMPORTED_MODULE_4___default()(_components_HideOnMobile__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(_templateObject7());
var StyledImageWrapper = styled_components__WEBPACK_IMPORTED_MODULE_4___default()(_components_ImageWrapper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(_templateObject8());
...
var Words = function Words(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_promise__WEBPACK_IMPORTED_MODULE_2___default.a, {
    ...
    function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(resolve) {
        var currentPage, data, wordsPageData, colour, colourHex, lightColourHex, _wordsPageData$header, header, subtitle, title, image, words, wordsCount, maxPageCount;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* getData */ "b"])('data/words/index.json');

              case 5:
                data = _context.sent;
                _context.next = 8;
                return Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* getData */ "b"])('data/pages/words.json');

              case 8:
                wordsPageData = _context.sent;
                colour = Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* getMenuColour */ "f"])(wordsPageData);
                colourHex = Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* changeColourToHex */ "a"])(colour);
                lightColourHex = Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* changeColourToHex */ "a"])(colour, true);
                _wordsPageData$header = wordsPageData.header, header = _wordsPageData$header === void 0 ? {} : _wordsPageData$header, subtitle = wordsPageData.subtitle, title = wordsPageData.title;
                image = Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* getFullUrl */ "c"])(header && header.image);
                words = Object.values(data).map(function (word) {
                  return word.data;
                }).sort(function (a, b) {
                  return moment__WEBPACK_IMPORTED_MODULE_3___default()(a.dateTime).isBefore(b.dateTime) ? 1 : -1;
                });
    ...
    then: function then(_ref3) {
      var colour = _ref3.colour,
          colourHex = _ref3.colourHex,
          lightColourHex = _ref3.lightColourHex,
          header = _ref3.header,
          title = _ref3.title,
          image = _ref3.image,
          subtitle = _ref3.subtitle,
          maxPageCount = _ref3.maxPageCount,
          words = _ref3.words,
      ...
      }), subtitle && subtitle.subtitle && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_PageSummary__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"], {
        color: colourHex
      }, subtitle.subtitle), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("ul", null, words.map(function (word) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("li", {
          key: word.title
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_router__WEBPACK_IMPORTED_MODULE_5__["Link"], {
          href: "/words/".concat(word.title)
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledLink, {
          colour: Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* changeColourToHex */ "a"])(word.colour, true)
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledTextContainer, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledText, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledDate, {
          colour: Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* changeColourToHex */ "a"])(word.colour)
        }, moment__WEBPACK_IMPORTED_MODULE_3___default()(word.date).format('DD.MM.YY')), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Title, null, word.title)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ReadMore, {
          colour: Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* changeColourToHex */ "a"])(word.colour)
        }, "Read More +")), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledHideOnMobile, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledImageWrapper, {
          colour: Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* changeColourToHex */ "a"])(word.colour)
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Image__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"], {
          url: Object(_helpers__WEBPACK_IMPORTED_MODULE_14__[/* getFullUrl */ "c"])(word.image)
        }))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Clearfix__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"], null))));
